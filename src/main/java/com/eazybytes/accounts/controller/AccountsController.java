...
@RestController
@Tag(
        name = "CRUD API for Accounts in Eazybank",
        description = "CRUD API for Accounts in EazyBank with FETCH, CREATE, UPDATE & DELETE"
)
...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "Get build informaiton that is deployed in into accounts microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Get contact details that can be reached out in the accounts microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
